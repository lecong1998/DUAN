...
import kotlinx.android.synthetic.main.fragment_t_v__ontv_.*
import kotlinx.android.synthetic.main.fragmentpopular.*


class TV_Ontv_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_t_v__ontv_, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        tv_recycleview_ontv?.layoutManager = GridLayoutManager(activity,2, GridLayoutManager.VERTICAL,false)
        ...
        tv_recycleview_ontv.adapter = adapter
