...
class adapter_profile(var listtitle : List<item>) : RecyclerView.Adapter<adapter_profile.Viewholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): adapter_profile.Viewholder {
        return  Viewholder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_profile,parent,false)
        )
    }

    override fun onBindViewHolder(holder: adapter_profile.Viewholder, position: Int) {
